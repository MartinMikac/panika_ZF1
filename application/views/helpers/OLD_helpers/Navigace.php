...
class Miki_View_Helper_Navigace {
	...
	public function navigace ( Venturia_Db_Rowset_ScrollAble $rowset , $page , $url ,$baseUrl ) {
		...
		$nav = '' ;
		$nav .= '<div class="galerieNavigace">' ;
		$nav .= "
		      <div style=\"float: left; clear:both; padding-top=50px;\">";
		if (($page ) > 0) {
			$nav .= "<a href=\"{$url}\"><img style=\"border: 0px;\" src=\"".$baseUrl."/public/images/page_bar/dvoj_sipka_leva.gif\" alt=\"\" height=\"23\" width=\"35\"/></a>";
		}else {
			$nav .= "<img style=\"border: 0px;\" src=\"".$baseUrl."/public/images/page_bar/dvoj_sipka_leva.gif\" alt=\"\"  height=\"23\" width=\"35\"/>";
		}

		
		if (($page - 1) >= 0) {
			$nav .= '<a href="?page='.($page-1).'">'; 
			$nav .= "<img class=\"noBorder\" src=\"".$baseUrl."/public/images/page_bar/sipka_leva.gif\" alt=\"\"  height=\"23\" width=\"27\"/> ";
			$nav .= '</a>';
		}else {
			$nav .= "<img class=\"noBorder\" src=\"".$baseUrl."/public/images/page_bar/sipka_leva.gif\" alt=\"\"   height=\"23\" width=\"27\"/> ";
		}
		...
		$nav .= '</div>';		
		 ...
		 if (($page + 1) < $rowset->pages()) {
			$nav .= '<a href="?page='.($page+1).'">';
			$nav .= "<img class=\"noBorder\" src=\"".$baseUrl."/public/images/page_bar/sipka_prava.gif\" alt=\"\"  height=\"23\" width=\"27\"/>";
			$nav .= '</a>';
		}else {
			$nav .= "<img class=\"noBorder\" src=\"".$baseUrl."/public/images/page_bar/sipka_prava.gif\" alt=\"\"  height=\"23\" width=\"27\"/>";
		}
		...
		if (($rowset->pages() ) != ($page+1)) {
			...
			$nav .= '<img class="noBorder" src="'.$baseUrl.'/public/images/page_bar/dvoj_sipka_prava.gif" alt=""   height="23" width="35"/>
				</a>';
		}else {
			$nav .= '<img class="noBorder" src="'.$baseUrl.'/public/images/page_bar/dvoj_sipka_prava.gif" alt=""   height="23" width="35"/>';
		}
